    ...
    <footer className="w-screen bg-violet-300 py-4 px-6 text-black">
        <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 md:flex-row">
            <p className="text-center text-sm md:text-left">
                &copy; Built by Indrayudh Dhara with @JavaScriptMastery
            </p>
            ...
            <a href="#privacy-policy" className="text-center text-sm hover:underline md:text-right">Inspiration zentry.com</a>
        </div>
